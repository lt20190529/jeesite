 ...
 * @version 2018-07-26
 */
public class ErpRecNew extends DataEntity<ErpRecNew> {
	...
	private List<ErpRecdetailNew> erpRecdetailNewList = Lists.newArrayList();		// 子表列表
	
	public ErpRecNew() {
		super();
	}

	public ErpRecNew(String id){
		super(id);
	}
	...
	public List<ErpRecdetailNew> getErpRecdetailNewList() {
		return erpRecdetailNewList;
	}

	public void setErpRecdetailNewList(List<ErpRecdetailNew> erpRecdetailNewList) {
		this.erpRecdetailNewList = erpRecdetailNewList;
	}
