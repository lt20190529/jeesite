...
<body>
	<div style="position:absolute;right:8px;top:22px;cursor:pointer;" onclick="search();">
		<i class="icon-search"></i><label id="txt">搜索</label>
	</div>
	<div id="search" class="form-search" style="padding:12px 0 0 13px;">
		<label for="key" class="control-label" style="padding:10px 22px 3px 0;">【关键字】：</label>
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:140px;">
		<!-- <button class="btn" id="btn" onclick="searchNode()">搜索</button> -->
	</div>
	<div id="tree" class="ztree" style="padding:30px 60px;"></div>
</body>