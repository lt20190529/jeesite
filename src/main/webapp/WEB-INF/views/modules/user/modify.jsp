                ...
                <div class="col-sm-10" style="width:890px;height:26.96px">
                    <div class='input-group date' id='companyD'>
                        ...
                        <sys:treeselect id="companyID" name="companyID"
                                        ...
                                        cssStyle="width:675px;height:26.96px"
                ...
                <div class="col-sm-10">
                    <div class='input-group date' id='officeD'>
                        ...
                        <sys:treeselect id="groupList" name="groupList"
                                        value="${sysUser.groupList}" labelName=""
                                        labelValue="${sysUser.groupList}" title="组别"
                    ...
                    <c:forEach items="${roleList}" var="roleList" varStatus="status">
                        <c:if test="${roleList.checked=='Y'}">
                            <label class="checkbox checkbox-inline">
                                <input id=${roleList.id} name="roleList" type="checkbox" checked
                                       value=${roleList.id}>${roleList.name}
                            </label>
                        </c:if>
                        <c:if test="${roleList.checked=='N'}">
                            <label class="checkbox checkbox-inline">
