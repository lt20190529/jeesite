...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <link href="${pageContext.request.contextPath}/static/bootstrap3-dialog-master/css/bootstrap-dialog.min.css"
          rel="stylesheet">
    ...
    <div class="row-fluid ">
        ...
        <div class="row">
            <div class="col-md-12 form-inline">
                <label class="col-sm-2" style="width:173px">所属公司：</label>
                <div class="col-sm-8">
                    <div class='input-group date' id='companyD'>
                        </label>
                        <sys:treeselect id="companyID" name="companyID"
                                        value="${sysUser.companyID}" labelName="company.name"
                                        labelValue="${sysUser.companyName}" title="公司"
        ...
        <div class="row">
            <div class="col-md-12 form-inline">
                <label class="col-sm-2" style="width:173px">所属公司组别：</label>
                <div class="col-sm-8" >
                    <div class='input-group date' id='officeD'>
                        </label>
                            <sys:treeselect id="officeID" name="officeID"
                                            value="${sysUser.officeID}"
                                            labelName="office.name" labelValue="${sysUser.officeName}" title="组别"
                                            url="/sys/office/treeData?type=2" cssClass="input-large"
                                            cssStyle="width:500px;height:26.96px"
                                            hideBtn="true" smallBtn="true" allowClear="true" isAll="true" allowInput="false"
                                            notAllowSelectParent="true"/>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 form-inline">
                ...
                <div class="controls" style="width:900px;height:80px">
                    <form:checkboxes path="roleIdList" items="${allRoleList}" delimiter="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" cssStyle="font-size: large" itemLabel="name" itemValue="id" htmlEscape="false" class="required"/>
