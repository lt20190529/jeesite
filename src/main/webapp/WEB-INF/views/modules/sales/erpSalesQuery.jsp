...
<script type="text/javascript">
	...
	function modify() {
			...
			$('#dg').datagrid({url:"${ctx}/sales/erpSales/getSalesMainList"});
			//清空明细
	...
	function onClickRow(index, row){
		var id = row["id"];
		$('#dgDetail').datagrid({url:"${ctx}/sales/erpSales/getSalesListjqGridDetail?ids=" + id});
	};
	...
	function initMainGrid(){
		$('#dg').datagrid({
		  ...
		  columns:[[
		      ...
		      {field:'buyername',title:'买方',width:300,align:"left",halign:"center",
		      	editor:{ 
		      		   type:'textReadonly'
		      		   }
		      },
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sales/erpSales/erpSalesQuery">销售<shiro:hasPermission
					name="sales:erpSales:Query">查询</shiro:hasPermission></a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="erpSales"
		action="${ctx}/sales/erpSales/erpSalesQuery" method="post"
		class="breadcrumb form-search">
		<ul class="ul-form">
			<li><label>销售单号：</label> <form:input path="no"
					htmlEscape="false" maxlength="50" class="input-medium" /></li>

			<li><label>销售部门：</label> <form:select path="depid"
					class="input-medium">
	...
	<div class="control-group">
		<label class="control-label">销售信息：</label>
		<div class="controls">
