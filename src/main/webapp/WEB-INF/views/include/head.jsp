...
<script src="${ctxStatic}/jquery/jquery.json-2.4.min.js" type="text/javascript"></script>
...
<!-- JQGrid相关 -->
<script src="${ctxStatic}/jqGrid/4.7/js/jquery.jqGrid.js" charset="utf-8"></script>  
<script src="${ctxStatic}/jqGrid/4.7/js/i18n/grid.locale-cn.js" type="text/javascript" charset="utf-8"></script> 
<link rel="stylesheet" href="${ctxStatic}/jqGrid/4.7/css/ui.jqgrid.css" media="all">
<script type="text/javascript">var ctx = '${ctx}', ctxStatic='${ctxStatic}';</script>
<!-- 统计图表 -->
<script type="text/javascript" src="${ctxStatic}/echartsjs/echarts.min.js"></script>


<!-- 引入EasyUI -->
<script type="text/javascript" src="${ctxStatic}/jquery-easyui/jquery.easyui.min.js"></script>
<script type="text/javascript" src="${ctxStatic}/jquery-easyui/plugins/datagrid-export.js"></script>
<script type="text/javascript" src="${ctxStatic}/jquery-easyui/locale/easyui-lang-zh_CN.js"></script>
<link rel="stylesheet" href="${ctxStatic}/jquery-easyui/themes/default/easyui.css" type="text/css"/>
<link rel="stylesheet" href="${ctxStatic}/jquery-easyui/themes/icon.css" type="text/css"/>
